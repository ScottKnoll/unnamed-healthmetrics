                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-6 space-y-6 bg-white sm:p-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <x-label for="smart_goals[specific]">Specific</x-label>
                                ...
                                <div>
                                    <x-label for="smart_goals[measurable]">Measurable</x-label>
                                ...
                                <div>
                                    <x-label for="smart_goals[achievable]">Achievable</x-label>
                                ...
                                <div>
                                    <x-label for="smart_goals[relevant]">Relevant</x-label>
                                ...
                                <div>
                                    <x-label for="smart_goals[time-bound]">Time-bound</x-label>
